<div id="sidebarLeft"
    class="fixed z-40 inset-0 flex-none h-full bg-black bg-opacity-25 w-full lg:bg-gray-100 lg:static lg:h-auto lg:overflow-y-visible lg:pt-0 lg:w-60 xl:w-72 lg:block hidden">
        ...
        <nav
            ...
            <ul class="px-3">
                ...
                <li class="flex items-center">
                    <span class="rounded-md h-6 w-6" style="background-color: #{{$category->color}}"></span>
                    <a href="#" class="px-3 py-2 text-base">
                        {{ $category->name }}
                    </a>
                </li>
                @endforeach
